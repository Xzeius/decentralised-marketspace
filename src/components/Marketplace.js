...
export default function Marketplace() {
    ...
    // Check if wallet is connected (does NOT touch loading)
    ...
    useEffect(() => {
        ...
        if (window.ethereum) {
            const handleAccountsChanged = async (accounts) => {
                if (accounts.length > 0) {
                    console.log("Accounts changed, wallet connected:", accounts[0]);
                    setIsWalletConnected(true);
                } else {
                    console.log("All accounts disconnected");
                    setIsWalletConnected(false);
                }
                // Refresh NFTs whenever accounts change
                await getAllNFTs();
            };
                    ...
                    <div className="w-full max-w-6xl">
                        ...
                        {!isLoading && !error && data.length > 0 && (
                            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                                ...
                                <Link
                                    to="/sellItem"
                                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 flex items-center"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-yellow-200 text-sm">
                                            Connect your wallet to buy items or access your
                                            account
                                        </p>
                                    </div>
                                    <button
